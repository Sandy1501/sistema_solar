...
<nav class="navbar navbar-expand-lg navbar-light mt-3" style="background-color: #81c9fa;">
  <div class="container">
      <div class="row mt-3">
...
<!--Informacion del cometa-->
<div class="container-fluid mt-4" style="background: -webkit-radial-gradient( #81c9fa, #b9ffff,#002973);">
    <div class="row justify-content-between">
        <div class="col col-sm-3">
            <h1 class="display-4 text-white text-center">Cometas</h1>
            <img src="{{ asset('img/cometa.png')}}" class="rounded mx-auto d-block" width="150"  alt="">
            <hr class="w-100">
            <p>
                
            </p>
            <p class="text-justify">
                Los cometas parecen manchas de luz, a menudo borrosas, que van dejando un rastro o cabellera. Esto los hace 
                atractivos y los rodea de magia y misterio. Los cometas son cuerpos frágiles y pequeños, de forma irregular, 
        ...
        <div class="col col-sm-3 mt-4">
            ...
            <br>
            <p class="text-justify">
                Un cometa consta de un núcleo, normalmente compuesto de hielo y roca, rodeado de una atmósfera nebulosa llamada 
                cabellera o coma. El astrónomo estadounidense Fred Whipple describió en 1949 el núcleo, que contiene casi toda 
                la masa del cometa, como una "bola de nieve sucia" compuesta por una mezcla de hielo y polvo.
        ...
        <div class="col col-sm-3 mt-3">
            ...
            <br>
            <p>
                <img src="raw/img/Lady.jpg" alt="" class="w-100">   
            </p>
            <p class="text-justify">
                Cuando los cometas se acercan al Sol y se calientan, los gases se evaporan, desprenden partículas sólidas y forman la 
                cabellera. Cuando se vuelven a alejar, se enfrían, los gases se hielan y la cola desaparece.
            </p>
            <br>
            <br>
            <img src="{{ asset('img/cometa2.png')}}" class="rounded mx-auto d-block" width="150"  alt="">
        </div>
    </div>
</div>
...
<footer class=" container-fluid mt-5 text-center">
    <div class="row justify-content-center py-4" style="height: 250px; background: #b9ffff">
        <div class="col">
...
<footer class="container-fluid">
    <div class="row" style="display: flex; justify-content: space-between; padding: 20px; background: #002973">
