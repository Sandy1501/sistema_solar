...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light mt-3" style="background-color: #666f88">
        <div class="container">
            <div class="row mt-3">
    ...
    <!--Informacion de la luna-->
    <div class="container-fluid mt-4" style="background: -webkit-radial-gradient(#666f88, #8990a2, #b5bac9);">
          <div class="row justify-content-between">
              <div class="col col-sm-3">
                  <h1 class="display-4 text-white text-center">Luna</h1>
                  <img src="{{ asset('img/luna.png')}}" class="rounded mx-auto d-block" width="150"  alt="">
                  <hr class="w-100">
                  <p>
                      
                  </p>
                  <p class="text-justify">
                      La luna es el único satélite que gira alrededor de nuestro planeta y tarda 28 días en dar una vuelta completa a la tierra. T
                      iene 2 movimientos principales, el movimiento de rotación, cuando gira sobre si misma, y el movimiento de traslación, cuando 
              ...
              <div class="col col-sm-3 mt-4">
                  ...
                  <br>
                  <p class="text-justify">
                      La luna a lo largo de los días va cambiando de forma. Estos cambios se llaman fases lunares y se repiten cada 28 días. 
                      Son cuatro: Luna llena, cuarto menguante, Luna nueva y cuarto creciente. Estas fases se producen por dos causas: el 
                      movimiento que hace alrededor de La Tierra y porque esta refleja la luz del Sol.
                  </p>
                  <br>
                  <br>
                  <p>
                      <img src="raw/img/dos.jpg" alt="" class="w-100">   
                  </p>
                  <br>
                  <br>
              ...
              <div class="col col-sm-3 mt-3">
                  ...
                  <br>
                  <br>
                  <img src="{{ asset('img/luna1.png')}}" class="rounded mx-auto d-block" width="150"  alt="">
              </div>
          </div>
    </div>
    ...
    <footer class=" container-fluid mt-5 text-center">
        <div class="row justify-content-center py-4" style="height: 250px; background: #b5bac9">
            <div class="col">
    ...
    <footer class="container-fluid">
        <div class="row" style="display: flex; justify-content: space-between; padding: 20px; background: #666f88">
